...
class BSTree {
    ...
    public:
         ...
         */
        void remove(const string &key); // The recursive call will be made without a helper
    ...
    private: // Helper functions
        // Helper to "destruct" the tree recursively
        void destructor_helper (Node *);
        // To write preOrder, inOrder, postOrder, search, recursively, it requires overloading. The recursive helper functions should be private.
        // need string parameter because a node contains string data value
        bool search_helper(Node *, const string &) const;
